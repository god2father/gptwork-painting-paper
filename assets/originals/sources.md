...
| painting-03-master | 《神奈川冲浪里》和纸母版 | 2026-07-15 | built-in image generation | `assets/originals/painting-03/generation.json` | 文字提示词与公共领域构图知识，无图像输入 | `assets/originals/painting-03/original.png` | 1536×1024 横向母版 |
| painting-03-background | 暖色和纸天空与平静远海 | 2026-07-15 | built-in image generation edit | `assets/originals/painting-03/generation.json` | GPT 母版 | `assets/layers/painting-03/background.webp` | 移除巨浪、船、富士山与泡沫后标准化 |
| painting-03-layers | 6 个透明运动图层 | 2026-07-15 | Pillow + NumPy registered-mask extraction | `scripts/extract_painting_03_layers.py` | GPT 母版 | `assets/layers/painting-03/layer-*.webp` | 原位色彩语义蒙版、无损 WebP |
